...
public interface ControladorGaraje {
	...
	void insertarVehiculo() throws GarajeException, Exception;

	void eliminarVehiculo() throws GarajeException, Exception;

	void leerTipoVehiculo() throws GarajeException;

	void leerTodosTiposVehiculo() throws GarajeException;

	void actualizarVehiculo() throws GarajeException;

	void crearPlaza() throws GarajeException;
